...
data object SHOW_FILE_NAMES_GRID : BooleanPref(false, "Show file names in grid", "Show the file name below photos in the grid view")
data object GRID_COLUMN_COUNT : IntListPref(4, "Columns", "Number of columns in the grid", R.array.grid_columns_titles, R.array.grid_columns_values)
